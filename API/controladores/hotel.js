...
export const hotelCreado = async (req, res, next) => {
  const hotelCreado = new Hotel(req.body);

  try {
    const hotelGuardado = await hotelCreado.save();
...
export const hotelActualizado = async (req, res, next) => {
  try {
